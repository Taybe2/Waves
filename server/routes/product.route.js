...
router.post('/product', auth('createAny', 'product'), addProductValidator, productController.addProduct);
...
///// DELETING IMAGES
router.post('/uploadRemove', auth('deleteAny', 'product'), productController.picDeleteById);
